                ...
                <div className="flex flex-wrap lg:flex-no-wrap items-baseline">
                    ...
                    <div className="lg:w-2/3 item-meta">
                        <div className="flex flex-wrap">
                            <h4 className="break-all font-light text-xl text-gray-700 py-3 lg:py-0 px-4 lg:px-0 lg:mb-4">Titxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxsxxxxxxxxxxxxxle</h4>
                        </div>
